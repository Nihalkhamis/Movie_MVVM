...
import com.movie.moviemvvm.data.api.TheMovieDBClient
...
class SingleMovie : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        viewModel.movieDetails.observe(this, Observer {
            bindUI(it) //it is MovieDetails type and this fun will update the ui if any changes occur
        })
    ...
    private fun getViewModel(movieID : Int) : SingleMovieViewModel{
       return ViewModelProviders.of(this, object : ViewModelProvider.Factory{
           override fun <T : ViewModel?> create(modelClass: Class<T>): T {
               @Suppress("UNCHAKED_CAST")
               return SingleMovieViewModel(movieRepository,movieID) as T
           }
       })[SingleMovieViewModel::class.java] //here a class reference of SingleMovieViewModel
